...
final class OrderStateMachineTest extends TestCase
{
    ...
    public function testAllowedActionsMatrix(): void
    {
        $expected = [
            ...
            'rejected' => ['student' => [], 'technician' => [], 'assistant' => [], 'admin' => ['reopen']],
            'cancelled' => ['student' => [], 'technician' => [], 'assistant' => [], 'admin' => ['reopen']],
            'no_show' => ['student' => [], 'technician' => [], 'assistant' => [], 'admin' => ['reopen']],
            'returned' => ['student' => [], 'technician' => [], 'assistant' => [], 'admin' => ['reopen']],
            'returned_late' => ['student' => [], 'technician' => [], 'assistant' => [], 'admin' => ['reopen']],
        ];
